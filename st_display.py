                        ...
                        with st.container(border=True):
                            ...
                            with col_img:
                                if os.path.exists(image_filename):
                                    ...
                                    st.warning("⚠️ <Missing Image> Error 429: Quota Exceeded @ Error 503: Gemini service is currently overloaded. Please try again in a few moments.")
                    except Exception as shot_error:
                        st.error(f"Error rendering {shot_key}: {shot_error}")
                        st.error("⚠️ <Missing Image> Error 429: Quota Exceeded @ Error 503: Gemini service is currently overloaded. Please try again in a few moments.")
